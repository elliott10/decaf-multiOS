    ...
    switch(opc)
    {
      ...
      case INDEX_op_deposit_i32: // Always bitwise taint
        ...
        if (arg0) {
          ...
          set_arg_i32(3, pos);
          set_arg_i32(4, len);
          set_concrete_i32(5, arg0);
          set_concrete_i32(6, arg1);
          set_concrete_i32(7, arg2);

          tcg_gen_helperN(helper_taint_log_deposit_i32, 0, 0, TCG_CALL_DUMMY_ARG, 8, helper_arg_array);
      ...
      case INDEX_op_setcond2_i32: // All-Around: UifU64() w/ mkPCastTo()
        ...
        if (arg0) {
          ...
          /* Reinsert original opcode */
          tcg_gen_setcond2_i32(orig0, orig1, orig2, orig3, orig4, orig5);
#endif /* TCG_LOGGING_TAINT */
          ...
          tcg_gen_setcond_i32(TCG_COND_NE, t2, t0, t1); // Reuse t2
      ...
      case INDEX_op_movi_i32: // Always bit taint
        ...
        if (arg0) {
          ...
          /* Insert logging */
          set_arg_i32(0, orig0);
          set_concrete_i32(1, arg0); 
          tcg_gen_helperN(helper_taint_log_movi_i32, 0, 0, TCG_CALL_DUMMY_ARG, 2, helper_arg_array);
          /* Reinsert original opcode */
      ...
      case INDEX_op_mov_i32:    // Always bit taint
        ...
        if (arg0) {
          ...
          set_arg_i32(0, orig0);
          set_arg_i32(1, orig1);
          set_concrete_i32(2, arg0);
          set_concrete_i32(3, arg1);
          tcg_gen_helperN(helper_taint_log_mov_i32, 0, 0, TCG_CALL_DUMMY_ARG, 4, helper_arg_array);
          /* Reinsert original opcode */
          ...
          if (arg0 || arg1) {
            ...
            if (taint_load_pointers_enabled) {
              ...
              if (arg2) {
                ...
                /* Check for pointer taint */
                tcg_gen_movi_i32(t0, 0);
                tcg_gen_setcond_i32(TCG_COND_NE, t1, arg2, t0);
      ...
      case INDEX_op_setcond_i32: // All-Around: UifU32() (mkLazy())
        ...
        if (arg0) {
          ...
          set_arg_i32(2, orig2);
          set_arg_i32(3, orig3);
          set_concrete_i32(4, arg0);
          set_concrete_i32(5, arg1);
          set_concrete_i32(6, arg2);

          tcg_gen_helperN(helper_taint_log_setcond_i32, 0, 0, TCG_CALL_DUMMY_ARG, 7, helper_arg_array);
          /* Reinsert original opcode */
          ...
          tcg_gen_movi_i32(t1, 0);
          tcg_gen_setcond_i32(TCG_COND_NE, t2, t0, t1);
          tcg_gen_neg_i32(arg0, t2);
      ...
      case INDEX_op_shl_i32: // Special - scalarShift()
        ...
        if (arg0) {
          ...
          set_arg_i32(1, orig1);
          set_arg_i32(2, orig2);
          set_concrete_i32(3, arg0);
          set_concrete_i32(4, arg1);
          set_concrete_i32(5, arg2);

          tcg_gen_helperN(helper_taint_log_shl_i32, 0, 0, TCG_CALL_DUMMY_ARG, 6, helper_arg_array);
          /* Reinsert original opcode */
          ...
          if (arg2) { 
            ...
            tcg_gen_movi_i32(t0, 0);
            tcg_gen_setcond_i32(TCG_COND_NE, t1, t0, arg2);
      ...
      case INDEX_op_shr_i32: // Special - scalarShift()
        ...
        if (arg0) {
          ...
          tcg_gen_helperN(helper_taint_log_shr_i32, 0, 0, TCG_CALL_DUMMY_ARG, 6, helper_arg_array);
          /* Reinsert original opcode */
      ...
      case INDEX_op_sar_i32: // Special - scalarShift()
        ...
        if (arg0) {
          ...
          tcg_gen_helperN(helper_taint_log_sar_i32, 0, 0, TCG_CALL_DUMMY_ARG, 6, helper_arg_array);
          /* Reinsert original opcode */
      ...
      case INDEX_op_rotl_i32: // Special - MemCheck does lazy, but we shift
        ...
        if (arg0) {
          ...
          tcg_gen_helperN(helper_taint_log_rotl_i32, 0, 0, TCG_CALL_DUMMY_ARG, 6, helper_arg_array);
          /* Reinsert original opcode */
      ...
      case INDEX_op_rotr_i32: // Special - MemCheck does lazy, but we shift
        ...
        if (arg0) {
          ...
          tcg_gen_helperN(helper_taint_log_rotr_i32, 0, 0, TCG_CALL_DUMMY_ARG, 6, helper_arg_array);
          /* Reinsert original opcode */
...
#if 0 // AWH - expensiveAddSub() for add_i32/or_i32 are buggy, use cheap one
      ...
      case INDEX_op_add_i32: // Special - expensiveAddSub()
        ...
        if (arg0) {
          ...
          /* Per the expensiveAddSub() logic:
             qaa = T1 = arg1
             qbb = T2 = arg2
             aa  = V1 = gen_opparam_ptr[-2]
             bb  = V2 = gen_opparam_ptr[-1] */
          tcg_gen_not_i32(t0, arg1); // ~T1
          tcg_gen_and_i32(t1, orig1, t0);//tcg_gen_and_i32(t1, gen_opparam_ptr[-2], t0); // V1 & ~T1 (a_min)
          
          tcg_gen_not_i32(t0, arg2); // ~T2
          tcg_gen_and_i32(t2, orig0, t0);//tcg_gen_and_i32(t2, gen_opparam_ptr[-1], t0); // V2 & ~T2 (b_min)

          tcg_gen_or_i32(t3, orig1, arg1);//tcg_gen_or_i32(t3, gen_opparam_ptr[-2], arg1); // V1 | T1 (a_max)
          tcg_gen_or_i32(t4, orig0, arg2);//tcg_gen_or_i32(t4, gen_opparam_ptr[-1], arg2); // V2 | T2 (b_max)

          tcg_gen_add_i32(t0, t3, t4); // a_max + b_max
          tcg_gen_add_i32(t3, t1, t2); // a_min + b_min
          tcg_gen_xor_i32(t1, t0, t3); // ((a_min + b_min)^(a_max + b_max))
          tcg_gen_or_i32(t0, t1, arg2); // T1 | all of that previous stuff
          tcg_gen_or_i32(arg0, t0, arg1); // T2 | all of that previous stuff
        }
        break;
      ...
      case INDEX_op_sub_i32: // Special - expensiveAddSub()
        ...
        if (arg0) {
          ...
          tcg_gen_sub_i32(t0, t1, t4); // a_min - b_max
          tcg_gen_sub_i32(t3, t3, t2); // a_max - b_min
          tcg_gen_xor_i32(t1, t0, t3); // ((a_min - b_max)^(a_max - b_min))
          tcg_gen_or_i32(t0, t1, arg2); // T1 | all of that previous stuff
          tcg_gen_or_i32(arg0, t0, arg1); // T2 | all of that previous stuff
        }
        break;
...
break;
        ...
        if (arg0) {
          ...
          tcg_gen_movi_i32(t1, 0);
          tcg_gen_setcond_i32(TCG_COND_NE, t2, t1, t0); 
          tcg_gen_neg_i32(arg0, t2);
...
#if 0 // AWH - expensiveAddSub() for add_i64/or_i64 are buggy, use cheap one
      /* T0 = (T1 | T2) | ((V1_min + V2_min) ^ (V1_max + V2_max)) */
      case INDEX_op_add_i64: // Special - expensiveAddSub()
        ...
        if (arg0) {
          ...
          /* Per the expensiveAddSub() logic:
             ...
             aa  = V1 = gen_opparam_ptr[-2]
             bb  = V2 = gen_opparam_ptr[-1] */
          tcg_gen_not_i64(t0, arg1); // ~T1
          tcg_gen_and_i64(t1, orig1, t0);//tcg_gen_and_i64(t1, gen_opparam_ptr[-2], t0); // V1 & ~T1 (a_min)

          tcg_gen_not_i64(t0, arg2); // ~T2
          tcg_gen_and_i64(t2, orig0, t0);//tcg_gen_and_i64(t2, gen_opparam_ptr[-1], t0); // V2 & ~T2 (b_min)

          tcg_gen_or_i64(t3, orig1, arg1);//tcg_gen_or_i64(t3, gen_opparam_ptr[-2], arg1); // V1 | T1 (a_max)
          tcg_gen_or_i64(t4, orig0, arg2);//tcg_gen_or_i64(t4, gen_opparam_ptr[-1], arg2); // V2 | T2 (b_max)

          tcg_gen_add_i64(t0, t3, t4); // a_max + b_max
          tcg_gen_add_i64(t3, t1, t2); // a_min + b_min
          tcg_gen_xor_i64(t1, t0, t3); // ((a_min + b_min)^(a_max + b_max))
          tcg_gen_or_i64(t0, t1, arg2); // T1 | all of that previous stuff
          tcg_gen_or_i64(arg0, t0, arg1); // T2 | all of that previous stuff
        }
        break;
      ...
      case INDEX_op_sub_i64: // Special - expensiveAddSub()
        ...
        if (arg0) {
          ...
          tcg_gen_sub_i64(t0, t1, t4); // a_min - b_max
          tcg_gen_sub_i64(t3, t3, t2); // a_max - b_min
          tcg_gen_xor_i64(t1, t0, t3); // ((a_min - b_max)^(a_max - b_min))
          tcg_gen_or_i64(t0, t1, arg2); // T1 | all of that previous stuff
          tcg_gen_or_i64(arg0, t0, arg1); // T2 | all of that previous stuff
        }
        break;
...
int optimize_taint(int search_pc) {
    ...
    return(gen_taintcheck_insn(search_pc));
}
